...
We value your originality and problem understanding. If you choose to use large language models (LLMs) when writing your proposal, we ask that you do so responsibly. Please make sure that your own knowledge, ideas, and insights form the core of your submission. While these tools can be helpful, they should not replace your own reasoning.
